...
const CitizenKnowledgeBase = () => {
  const [searchQuery, setSearchQuery] = useState('');

  return (
    <>
      <Helmet>
        <title>Knowledge Base - Citizen Portal</title>
      </Helmet>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Search our knowledge base or get AI assistance for your questions
            </p>
          </div>
        </div>
...
export default CitizenKnowledgeBase;
