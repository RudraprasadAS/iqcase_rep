...
-- First, let's completely disable RLS temporarily to clear any conflicts
ALTER TABLE cases DISABLE ROW LEVEL SECURITY;

-- Drop ALL existing policies on the cases table to start fresh
...
-- Recreate the security definer functions (ensuring they exist)
...
-- Create the new RLS policies using the security definer functions
